...
public class MainPage1 {
	...
	private void initialize() {
		...
		JLabel lblNewLabel_2 = new JLabel("liste des objet en ventes:");
		lblNewLabel_2.setBounds(424, 14, 158, 14);
		panel_1.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("unite:");
		...
		JLabel lblNewLabel_9_1 = new JLabel("category:");
		lblNewLabel_9_1.setBounds(10, 49, 74, 14);
		panel_5.add(lblNewLabel_9_1);
		
		JLabel lblNewLabel_9_2 = new JLabel("sous-category");
		...
		panel_6_1.setBackground(Color.ORANGE);
		...
		JLabel lblNewLabel_11_1 = new JLabel("information du client:");
		...
		panel_7_1.setBackground(Color.GREEN);
		panel_7_1.setBounds(0, 326, 414, 99);
		...
		panel_3_1.setBackground(Color.GREEN);
		...
		panel_5_1_1.setBackground(Color.RED);
		...
		JLabel lblNewLabel_9_2_1_1_1 = new JLabel("adress:");
		...
		panel_6_1_1.setBackground(Color.ORANGE);
		...
		panel_7_1_1.setBackground(Color.GREEN);
